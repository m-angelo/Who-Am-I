...
public class RePlay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView player = v.findViewById(R.id.player);
        ImageView friend = v.findViewById(R.id.friend);
        ...
        final Animation frombot = AnimationUtils.loadAnimation(getActivity(),R.anim.playfrombot);
        ...
        lvlview.setAnimation(fadein);
        question.setAnimation(fadein);
        player.setAnimation(fadein);
        friend.setAnimation(fadein);
        categview.setAnimation(fadein);
        bar.setAnimation(fadein);
        background.setAnimation(frombot);
        choice1.setAnimation(frombot);
        choice2.setAnimation(frombot);
        choice3.setAnimation(frombot);
        choice4.setAnimation(frombot);
                ...
                if (counter[0] == 3) {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            choice4.startAnimation(fadeout);
                            if (counter[0]==1){
                                question.setText("Drugie pytanie");
                                choice1.setText("1");
                                choice2.setText("2");
                                choice3.setText("3");
                                choice4.setText("4");
                            }else if (counter[0]==2){
                                question.setText("Trzecie pytanie");
                                choice1.setText("1");
                                choice2.setText("2");
                                choice3.setText("3");
                                choice4.setText("4");
